...
} // he halledersin onu agam ben cikiom ozmn
...
void Dialog::AddCustomMargin()
{
	dialogstr.append("add_custom_margin|x:0;y:-35|");
}
void Dialog::AddCustomMargin2()
{
	dialogstr.append("add_custom_margin|x:0;y:10|");
}
